...
function Maincontent(){
    ...
    return(
        <div className="flex flex-col gap-5">
                    <div className="">
                        <div className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow flex justify-between items-center">
                            <div>
                                <h1 className="text-4xl font-bold text-gray-800 mb-2">Welcome back!</h1>
                                <p className="text-gray-600">Here's what's happening with your messages today.</p>
                            </div>
                            <button
                            onClick={navigatetocraete}
                            className="bg-[#ced7de] text-black px-6 py-3 rounded-lg hover:bg-[#b8c5cc] transition-colors duration-200 flex items-center gap-2 font-medium hover:cursor-pointer">
                                <Plus size={20} />
                                New Message
                            </button>
                        </div>
