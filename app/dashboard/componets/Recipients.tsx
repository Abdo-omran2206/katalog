...
import { Search, Plus, Edit, Trash2, Phone, Mail, User, Filter } from 'lucide-react';
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-2xl font-bold text-purple-600">
                                {recipients.reduce((sum, r) => sum + r.messageCount, 0)}
                            </p>
                        </div>
                    ...
                    <tbody>
                        {filteredRecipients.map((recipient) => (
                            <tr key={recipient.id} className="border-b border-gray-100 hover:bg-gray-50">
                                <td className="py-4 px-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-500">ID: {recipient.id}</p>
                                        </div>
                                    </div>
                                </td>
                                <td className="py-4 px-4">
                                ...
                                <td className="py-4 px-4">
                                    <span className="text-sm font-medium text-gray-900">{recipient.messageCount}</span>
                                </td>
