        ...
        <div className="min-h-screen bg-[#d0d8df]">
            <header>
                <nav className="flex justify-between items-center px-2 py-5 bg-[#f2f2f2] shadow-sm">
                    ...
                    <div className="flex items-center gap-5">
                        ...
                        className="text-black flex items-center gap-3 hover:cursor-pointer hover:bg-white px-5 py-2 rounded-xl transition duration-200 "> <ArrowLeft size={20}/> Back to Dashboard</button>
            ...
            <main className="max-w-4xl mx-auto px-6 py-8 ">
                <div className="bg-white rounded-lg shadow-lg p-8">
                    <h1 className="text-3xl font-bold mb-2">Create New Message</h1>
                    <p className="mb-8">Create a heartfelt message that will be delivered to your loved ones</p>
                    
                    <form className="space-y-8" onSubmit={handleSubmit}>
                        <div className="space-y-4">
                            <label htmlFor="title" className="block text-sm font-medium text-black">Message Title</label>
                            <input 
                                type="text" 
                                id="title"
                                name="title"
                        ...
                        <div className="space-y-4">
                            <label htmlFor="content" className="block text-sm font-medium text-black">Message Content</label>
                            <textarea 
                                name="message" 
                                id="content"
                                rows={6}
                        ...
                        <div className="space-y-4">
                            <label className="block text-sm font-medium text-black">Add files (image, audio, video)</label>
                            ...
                            >
                                ...
                                <p className="text-gray-600 mb-4">Click to upload your image file or drag and drop</p>
                                <input
                                    type="file"
                                    multiple
                        ...
                        <div className="space-y-4">
                            <div className="flex justify-between items-center">
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-2 px-4 py-2 bg-[#ced7de] text-black rounded-md hover:bg-[#b8c5cc] transition duration-200"
                                >
                                    <Plus size={16} />
                                    Add Recipient
                                </button>
                            ...
                            <div className="space-y-4">
                                {recipients.map((recipient) => (
                                    <div key={recipient.id} className="flex gap-4 items-start">
                                        ...
                                        <button
                                            ...
                                            className="p-2 text-gray-400 hover:text-red-500 transition duration-200 mt-6"
                        ...
                        <div className="pt-6">
                            <button 
                                type="submit"
                                className="w-full bg-[#ced7de] text-black py-3 px-6 rounded-md hover:bg-[#b8c5cc] transition duration-200 font-medium hover:cursor-pointer"
                            >
                                Create Message
                            </button>
                        </div>
